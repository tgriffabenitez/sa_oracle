-- AGREGAR EMPLEADO ------------------------------------------------------------
DECLARE
    v_first_name     hr.employees.first_name%TYPE := 'TOMAS';
    v_last_name      hr.employees.last_name%TYPE := 'GRIFFA';
    v_email          hr.employees.email%TYPE := 'tgriffa';
...
-- ELIMINAR EMPLEADO -----------------------------------------------------------
DECLARE
    v_employee_id hr.employees.employee_id%TYPE := 210;
    v_error_msg   VARCHAR2(200);
    v_result      BOOLEAN;
BEGIN
...
DECLARE
    ...
    v_job_title  hr.jobs.job_title%TYPE := 'HOLAHOLA';
...
-- ELIMINAR JOB ---------------------------------------------------------------
DECLARE
    v_job_id    hr.jobs.job_id%TYPE := 'IT_PROG';
    v_error_msg VARCHAR2(200);
    v_result    BOOLEAN;
BEGIN
